  ...
  return (
    <div className="px-6 animate-slide-up">
      ...
      <div className="flex flex-col items-center mb-10">
        <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-3xl flex items-center justify-center shadow-lg mb-4 relative">
          <ClipboardList className="w-10 h-10 text-white" />
          <div className="absolute -bottom-2 -right-2 bg-emerald-400 rounded-full p-1 border-4 border-white dark:border-slate-900 transition-colors duration-300">
      ...
      {/* Crear lista */}
      <div className="bg-gray-50 dark:bg-slate-800 rounded-3xl p-5 mb-4 shadow-sm border border-gray-100 dark:border-slate-700/50 transition-colors duration-300">
        ...
        <form onSubmit={handleCreateList} className="flex gap-3">
          ...
          <input
            ...
            className="flex-1 bg-white dark:bg-slate-900/50 border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400 transition-all duration-300"
          />
          <button
            type="submit"
            className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
          >
            Crear
          </button>
        </form>
      ...
      {/* Unirse a lista */}
      <div className="bg-gray-50 dark:bg-slate-800 rounded-3xl p-5 mb-8 shadow-sm border border-gray-100 dark:border-slate-700/50 transition-colors duration-300">
        ...
        <form onSubmit={handleJoinList} className="flex gap-3">
          ...
          <input
            ...
            className="flex-1 bg-white dark:bg-slate-900/50 border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 uppercase transition-all duration-300"
          />
          <button
            type="submit"
          ...
          <div className="space-y-3">
            {lists.map((list) => {
              ...
              return (
                <button
                  ...
                  className="group w-full bg-gray-50 dark:bg-slate-800 rounded-2xl p-5 flex items-center justify-between border border-gray-100 dark:border-slate-700/50 hover:border-emerald-400 dark:hover:border-emerald-400 transition-all duration-300 text-left shadow-sm hover:shadow-md"
                >
                  <div>
            ...
            {lists.length === 0 && (
              <div className="text-center py-10 border-2 border-dashed border-gray-200 dark:border-slate-700 rounded-3xl">
                <p className="text-slate-500">No tienes listas aún.</p>
              </div>
            )}
          </div>
        )}
